...
class Day24Test {
    ...
    void part1_example() {
        ...
        String binaryResult = solvePart1(input);
        int actual = Integer.parseInt(binaryResult, 2);
    ...
    @Test
    void part1() {
        List<String> input = PuzzleInput.asStringListFrom("data/day24.txt");
        String binaryResult = solvePart1(input);

        //TODO parse big binary into Big Integer
        BigInteger actual = new BigInteger(binaryResult, 2);
        assertEquals(new BigInteger("60614602965288"), actual);
    }
